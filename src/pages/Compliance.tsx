...
/**
 * Compliance: facility credentialing (RepTrax/Symplr).
 *
 * Rep certifications used to live here too. They were removed -- they fed a
 * readiness check nobody maintained, and the real record of them is RepTrax.
  ...
  return (
    <div className="min-h-screen px-4 pb-24 pt-6">
      ...
      <p className="mt-1 text-sm text-slate-400">
        Facility credentialing (RepTrax, Symplr…), cross-checked against
